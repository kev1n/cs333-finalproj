...
Each jittered point is one district and the boxplots summarize the
distribution within each need group. The pattern isn't identical district to
district, but both metrics shift upward as need rises, with a noticeably
heavier right tail. Disadvantaged districts face structural challenges that
go beyond student test scores, including less stable teacher staffing.
Combined with absenteeism, the score gap isn't only about what students bring
to school; it's about what school brings to them.