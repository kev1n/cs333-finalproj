...
how wide that gap actually is, and whether it's moving.

### A 13-point gap that doesn't budge
...
Disadvantaged students sit roughly 13–14 scale-score points behind their peers
in both subjects, and the gap barely moves between 2024 and 2025. Math runs a
hair wider than ELA, but the two subjects don't share a scale, so that's a
soft observation.
...
show up, and who's teaching them.

### Showing up isn't equal either
...
```
Economically disadvantaged students miss roughly twice as much school as
their peers. You can't close an academic gap from outside the building, which
makes absenteeism a plausible cause, not just a symptom.

### High-need districts shoulder rougher staffing too

Teacher data doesn't break down by student subgroup, so we shift to the
...
The chart shows that high-need districts generally have higher percentages of inexperienced teachers and teachers working out of certification. The boxplots summarize the distribution of teacher staffing conditions within each need group. The pattern is not identical for every district, but the overall distribution shifts upward for high-need districts, especially for districts with unusually high teacher instability. This suggests that disadvantaged districts may face structural challenges beyond student test scores, including less stable teacher staffing.